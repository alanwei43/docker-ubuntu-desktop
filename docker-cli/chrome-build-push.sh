...
DOCKER_FILE="./temp/Dockerfile-$UBUNTU_VERSION.chrome-$CHROME_VERSION"
...
sed "s/chrome-version.deb/chrome-$CHROME_VERSION.deb/" ./Dockerfile-$UBUNTU_VERSION.chrome > $DOCKER_FILE && \
...
echo "alanway/ubuntu-desktop:$DOCKER_TAG Done."